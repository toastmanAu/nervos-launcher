...
DEFAULT_COMMANDS = {
    ...
    "Install": [
        ...
        ["Install ffmpeg-full", "python3 -c \"import sys;sys.path.insert(0,'/userdata/ckb-light-client/nervos-launcher');from lib.packages import PackageManager;from lib.installer import ProgressLog;p=ProgressLog();pm=PackageManager(progress=p);pm.install('ffmpeg-full');[print(l[0]) for l in p.get_lines()]\""],
